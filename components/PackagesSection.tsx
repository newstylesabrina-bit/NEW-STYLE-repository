        ...
        {selectedPackage && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
            ...
            >
              ...
              <button 
                onClick={closeModal}
                className="absolute top-6 right-6 z-10 p-2 rounded-full bg-white/20 backdrop-blur-md text-espresso hover:bg-gold hover:text-white transition-all shadow-lg"
              >
                <X size={24} />
              </button>
              ...
              <div className="w-full md:w-3/5 p-8 md:p-12 overflow-y-auto custom-scrollbar">
                <div className="mb-8">
                  ...
                  <h2 className="text-4xl md:text-5xl font-serif text-espresso mb-2">{selectedPackage.name}</h2>
